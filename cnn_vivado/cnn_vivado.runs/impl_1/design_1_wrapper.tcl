...
namespace eval ::optrace {
  variable script "G:/source/board/cnn_vivado/cnn_vivado.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet G:/source/board/cnn_vivado/cnn_vivado.runs/synth_1/design_1_wrapper.dcp
